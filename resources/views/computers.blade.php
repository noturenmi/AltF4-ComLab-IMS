            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('computers.store') }}" method="POST" id="new-comp"
                            class="d-flex flex-column gap-3">
                            @csrf
                            <div class="form-floating">
                                <input type="text" name="comp_name" id="comp-name" class="form-control" placeholder=""
                                    autocomplete="off">
                                <label for="comp-name">Computer Name</label>
                            </div>
                            <div class="form-floating">
                                <input type="text" name="comp_model" id="comp-model" class="form-control" placeholder=""
                                    autocomplete="off">
